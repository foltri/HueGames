...
public class AccessPointListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(com.philips.lighting.huegames.R.layout.selectbridge_item, null);

            item = new BridgeListItem();
            item.bridgeMac = (TextView) convertView.findViewById(com.philips.lighting.huegames.R.id.bridge_mac);
            item.bridgeIp = (TextView) convertView.findViewById(com.philips.lighting.huegames.R.id.bridge_ip);
